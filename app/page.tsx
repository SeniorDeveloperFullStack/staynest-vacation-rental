  ...
  return (
    <>
      <section className="home-hero">
        ...
        <div className="shell hero-content"><p>Exceptional homes | Unforgettable places</p><h1>Stay somewhere<br /><em>remarkable.</em></h1><span>Curated vacation homes for quiet mornings, long dinners, and the moments you keep.</span><Link className="button button-light" href="/properties">Explore all 4 homes <Icon name="arrow" /></Link></div>
      ...
      <section className="section featured-section"><div className="shell"><div className="section-heading"><div><div className="section-kicker">Find your place</div><h2>All 4 StayNest homes.</h2></div><Link href="/properties" className="text-link">View the full collection <Icon name="arrow" /></Link></div><div className="property-grid home-property-grid">{properties.map((property) => <PropertyCard property={property} key={property.slug} />)}</div></div></section>
